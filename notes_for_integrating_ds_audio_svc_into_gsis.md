...
The first modification is to modify the [`AndroidManifest.xml` file of the service app](https://github.com/InsertX2k/a14gsifixesa20s/blob/main/ds_incall_audio_svc_app_src/src/main/AndroidManifest.xml) to achieve the following:
